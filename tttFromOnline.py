...
# Load a color image 
file_name = "G:\My Drive\Fall 2021\CSCI 1430\gameNight\\testImages\\ttt_marker.jpg"
...
# solve next best move
ptm = 0
if numx > numo:
    ptm = 1
board = TTTProblem(board=gamestate, player_to_move=ptm)
# print(board_to_pretty_string(board))
move = adversarialsearch.minimax(board)
if ptm == 0:
    gamestate[move[0]][move[1]] = "X"
elif ptm == 1:
